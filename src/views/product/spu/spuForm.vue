    ...
    <el-form label-width="100px">
        ...
        <el-form-item label="SPU品牌">
            <el-select v-model="SpuParams.tmId">
                <el-option v-for="(item, $index) in AllTradeMark" :label="item.tmName" :key="item.id" :value="item.id">
                </el-option>
            </el-select>
        </el-form-item>
        ...
        <el-form-item label="SPU销售属性">
            ...
            <el-table style="margin-top: 20px;" border :data="saleAttr">
                ...
                <el-table-column label="销售属性值">
                    <template #="{ row, $index }">
                        <el-tag style="margin:0px 5px" v-for="(item, index) in row.spuSaleAttrValueList" :key="row.id"
                            class="mx-1" @close="row.spuSaleAttrValueList.splice(index, 1)" closable>
                ...
                <el-table-column label="操作">
                    <template #="{ row, $index }">
                        <el-button type="primary" icon="Delete" @click="saleAttr.splice($index, 1)">
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div style="margin-top: 20px;">
                <el-button type="primary" :disabled="saleAttr.length > 0 ? false : true" @click="save"> 保存 </el-button>
...
//计算出当前SPU还未拥有的销售属性  应该是属性值一遍自动计算
